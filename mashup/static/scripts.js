...
$(function() {
    ...
    var options = {
        center: {lat: 49.8951, lng: -97.1384}, // Winnipeg, Manitoba
...
function addMarker(place)
{
    ...
    // set marker at locations in the database
    ...
    markers.push(marker);
    // fetch the articles for the location
    if (place.country_code == "US"){
        $.getJSON("/articles?geo=" + place.postal_code, function(data){
           ...
           google.maps.event.addListener(marker, 'click', function(){
              // create the html 
              var articles = "<ul>";
              // iterate over articles and create list item with link
              for (var i = 0; i < 10; i++) {
        ...
        $.getJSON("/articles?geo=" + place.admin_name2, function(data){
           // listen for a click on the marker
           google.maps.event.addListener(marker, 'click', function(){
              // create the html 
              var articles = "<ul>";
...
function removeMarkers()
{
    ...
    google.maps.event.addListener(map, 'dragstart', function(){
        // iterate through markers, setting them to null
